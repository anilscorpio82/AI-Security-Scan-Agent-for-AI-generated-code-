...
import { Shield, ShieldAlert, FileSearch, Code, Bug, LogOut } from 'lucide-react';
import './index.css';
  ...
  return (
    <div className="app-container">
      <header className="header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <button className="glow-btn" onClick={onLogout} style={{ padding: '8px 16px', background: 'transparent', border: '1px solid var(--accent-cyan)' }}>
